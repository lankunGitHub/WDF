...
#define MAX_THREAD_NUM sysconf(_SC_NPROCESSORS_CONF)
...
public:
    inline thread_pool() : quit_thread(true)
    {
        this->max_size_thread = sysconf(_SC_NPROCESSORS_CONF);
        this->free_thread = this->max_size_thread - DEFAULT_SIZE;
