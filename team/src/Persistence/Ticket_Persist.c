...
int Ticket_Perst_SelectBySchID(ticket_list_t list, int schedule_id)//�����ݳ��ƻ�ID����Ʊ������
{
	assert(NULL!= list);
...
int Ticket_Perst_Insert(int schedule_id,seat_list_t list)
{
	...
	if(!fp) printf("��ʧ��%s",TICKET_DATA_FILE);
...
int Ticket_Perst_Rem(int schedule_id)//�����ݳ��ƻ�ID��ȡ�ݳ�Ʊ 
{
...
int Ticket_Perst_SelectAll(ticket_list_t ticket_list)//����ȫ���ݳ�Ʊ 
{
