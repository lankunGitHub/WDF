...
int Ticket_Perst_SelectBySchID(ticket_list_t list, int schedule_id)//根据演出计划ID载入票房数据
{
	assert(NULL!= list);
...
int Ticket_Perst_Rem(int schedule_id)//根据演出计划ID获取演出票 
{
...
int Ticket_Perst_SelectAll(ticket_list_t ticket_list)//载入全部演出票 
{
